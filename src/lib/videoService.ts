...
export const videos: Video[] = [
  ...
  {
    id: 'product-4',
    title: 'Tropical Fruit Farm Harvest - Rambutan & More',
    description: 'Amazing agricultural technology capturing the harvest of rambutan, lychee, and longan from tropical farms.',
    category: 'product-demo',
    productId: 'rambutan',
    ...
    creator: 'Amazing Agriculture',
    tags: ['rambutan', 'harvest', 'farming'],
  },
